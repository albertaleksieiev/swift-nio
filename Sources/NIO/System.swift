...
#if os(Android)
func sysRecvFrom_wrapper(sockfd: Int32, buf: UnsafeMutableRawPointer, len: Int, flags: Int32, src_addr: UnsafeMutablePointer<sockaddr>, addrlen: UnsafeMutablePointer<socklen_t>) -> Int {
    return recvfrom(sockfd, buf, len, flags, src_addr, addrlen) // src_addr is 'UnsafeMutablePointer', but it need to be 'UnsafePointer'
}
func sysWritev_wrapper(fd: Int32, iov: UnsafePointer<iovec>?, iovcnt: Int32) -> Int {
    return Int(writev(fd, iov, iovcnt)) // cast 'Int32' to 'Int'
}
